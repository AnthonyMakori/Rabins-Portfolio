...
const Contact = () => {
  ...
  return (
    <section id="contact">
      <div className="bg-gray-200 py-10"style={{ backgroundColor: '#0070f3' }}>
        <h1 className="text-4xl font-bold text-white text-center mb-4">
          Contact
        </h1>
        <p className="text-black text-center mb-6" style={{ paddingLeft: '20px', marginRight: '20px' }}>
        ...
        <p className="text-aqua font-bold text-center mb-6">
